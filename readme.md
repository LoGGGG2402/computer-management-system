...
2. **Install on Client Machine**
   ...
   - Agent configuration will be stored in:
     - `C:\ProgramData\CMSAgent\runtime_config\runtime_config.json`
     - `C:\Program Files\CMSAgent\appsettings.json`
</details>
...
<div align="center">
  ...
  ┃   (Browser)  ┃    Status      ┃  COORDINATION   ┃     Status     ┃  (Windows)  ┃
  ┃              ┃    Updates     ┃     CENTER      ┃     Data       ┃             ┃
  ┃              ┃    MFA         ┃                 ┃                ┃             ┃
  ┃              ┃                ┃                 ┃                ┃             ┃
  ┃              ┃                ┃     ┏━━━━┓      ┃                ┃             ┃
