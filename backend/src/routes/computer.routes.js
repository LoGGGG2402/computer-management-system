...
router.get(
  "/:computerId",
  authAccess({ checkComputerIdParam: true }),
  computerController.getComputerById
);
...
router.get(
  ...
  computerController.getComputerErrors
);
router.post(
  "/:computerId/errors",
  requireComputerAccess,
  computerController.reportComputerError
);
router.put(
  "/:computerId/errors/:errorId/resolve",
  requireComputerAccess,
  computerController.resolveComputerError
);
