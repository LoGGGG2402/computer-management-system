...
router.post('/agents/versions', uploadAgentPackage, adminController.handleAgentUpload);
router.put('/agents/versions/:versionId', adminController.setAgentVersionStability);
